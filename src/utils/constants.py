...
class Collections(Enum):
    theater: CollectionAttributes = CollectionAttributes(collection_name="Theatre", connection=None)
    slots: CollectionAttributes = CollectionAttributes(collection_name="Slots", connection=None)
    decorations: CollectionAttributes = CollectionAttributes(
        collection_name="Decorations", connection=None
    )
    addons: CollectionAttributes = CollectionAttributes(collection_name="Addons", connection=None)
    coupons: CollectionAttributes = CollectionAttributes(collection_name="Coupons", connection=None)
    bookings: CollectionAttributes = CollectionAttributes(
        collection_name="Bookings", connection=None
    )
    roles: CollectionAttributes = CollectionAttributes(collection_name="Roles", connection=None)
